...
if (true) {
  document.getElementById("esc").addEventListener("click", function () {
    myWindow = window.open('google.com');
    console.log("closing.");
    myWindow.close();
    console.log("closed."); // window.location.replace('google.com');
  });
}
...
//# sourceMappingURL=name.js.5aa7b69571171219ed8a.hot-update.js.map